...
![configinput2](https://image.prntscr.com/image/KLPy4otFTs6a2A6t8HGV4Q.png)
...
Trong giao diện mới, khai báo theo thông số như sau, lưu ý các thông số trong khung `Configuration`

![configsidecar4](https://image.prntscr.com/image/mxbPHPrJQp2MPaAkpmgkKg.png)
