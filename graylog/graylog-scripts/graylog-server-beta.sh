#!/bin/bash
#############################################################
# Graylog V2.1.0_beta4
# Ubuntu 14.04.1
# Update: 19/08/2016
# Author: Congto / @tothanhcong
#############################################################
# Run with root account  
# wget https://raw.githubusercontent.com/hocchudong/log-script/master/graylog/graylog-server-beta.sh
...
apt-get -y install git curl build-essential oracle-java8-installer pwgen wget ssh ntp
